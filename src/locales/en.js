export default {
  translation: {
    ...
    scanExtra: {
      ...
      relatedResults: 'Related scam results', relatedUnavailable: 'Related scam matches are temporarily unavailable. The scan result above is still available.', relatedNone: 'No closely related scam cases were found. The AI assessed this content independently.', relatedCase: 'Related scam case', match: '{{percent}}% match', independentConfidence: 'Independent AI confidence: {{percent}}%', viewSource: 'View source',
      riskLevel: '{{risk}} risk', riskLabels: { High: 'High', Medium: 'Medium', Low: 'Low', Unknown: 'Unknown' }, assessment: { NO_STRONG_WARNING_SIGNS: 'No strong warning signs', INSUFFICIENT_EVIDENCE: 'Insufficient evidence', CAUTION: 'Caution', SUSPICIOUS: 'Suspicious', STRONG_SCAM_INDICATORS: 'Strong scam indicators', UNABLE_TO_ASSESS: 'Unable to assess' }, relation: { LIKELY_RELATED: 'Likely related', CONTEXTUAL: 'Contextual' },
