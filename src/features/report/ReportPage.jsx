  ...
  return (
    <main className="min-w-0" id="main-content">
      <Card className="mx-auto max-w-2xl p-7 text-center sm:p-9">
        ...
        <p className="mb-0 mt-4 text-xs font-bold uppercase tracking-wide text-brand-700">
          Analysis required
        </p>
        <h1 className="mb-2 mt-1 text-2xl font-bold text-brand-900">
          Analyze the content before reporting
        </h1>
        <p className="m-0 text-sm leading-6 text-muted">
          Reports are linked to an analysis result so the suspicious text or URL
          and its assessment can carry over accurately.
        </p>
        <Link
          to="/analysis"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="m-0 text-sm leading-6 text-muted">
          Please wait while we submit your report for review.
        </p>
      </section>
    </div>
  );
      ...
      <main className="min-w-0 lg:px-10" id="main-content">
        <Card className="mx-auto max-w-2xl p-7 text-center sm:p-9">
          ...
          <p className="mx-auto mb-0 mt-2 max-w-lg text-sm leading-relaxed text-muted">
            Your report has been submitted and saved for review.
          </p>
    ...
    <main className="min-w-0 px-0 sm:px-4 lg:px-10" id="main-content">
      <div className="mb-5">
        ...
        <p className="m-0 max-w-2xl text-sm text-muted">
          The analyzed content and safety assessment have already been carried
          over. Tell us only what happened.
        </p>
      </div>
      <Card className="mb-4 border-[#cbdcf0] bg-[#f8fbff] p-4 sm:p-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <Badge tone={toneFor(analysis.risk)}>{analysis.risk} risk</Badge>
        </div>
        ...
        <p className="mb-0 mt-3 text-sm leading-6 text-muted">
          <strong className="text-[#40546b]">Assessment:</strong>{" "}
        ...
        <form className="grid gap-5 p-5 sm:p-6" onSubmit={submit} noValidate>
          <label className="grid gap-1.5 text-sm font-bold text-ink">
            ...
            <textarea
              ...
              placeholder="For example: I received this message after an order, and the sender asked me to pay a fee."
            />
          </label>
          <p className="-mt-3 mb-0 text-xs leading-5 text-muted">
            Do not include passwords, OTP codes, banking details, or other
            private information.
          </p>
          <div className="rounded-xl border border-line bg-[#fbfcfe] p-4">
            ...
            <ul className="mb-0 mt-2 grid gap-1 pl-5 text-sm leading-6 text-muted">
              <li>Analyzed text or URL</li>
              <li>{analysis.risk} assessment and detected indicators</li>
              <li>
                {analysis.matchedScamCases?.length || 0} similar scam case
                reference{analysis.matchedScamCases?.length === 1 ? "" : "s"}
              </li>
            </ul>
          </div>
          <label className="flex items-start gap-3 text-sm leading-6 text-muted">
            ...
            />
            <span>
              I confirm this report is honest and does not expose private
              information.
            </span>
          </label>
          {error ? (
