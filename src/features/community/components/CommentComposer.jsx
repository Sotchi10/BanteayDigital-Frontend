...
export function CommentComposer({ currentUser, onSubmit, compact = false, autoFocus = false, onCancel }) {
  ...
  return (
    <form className="space-y-2" onSubmit={submit}>
      <textarea
        ...
        placeholder={compact ? 'Write a reply…' : 'Add helpful context or a safety tip…'}
        value={content}
      />
