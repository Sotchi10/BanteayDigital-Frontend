...
export function AlertsPage() {
  ...
  return (
    <main className="min-w-0" id="main-content">
      <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><p className="m-0 text-xs font-bold uppercase tracking-[0.1em] text-brand-700">Safety updates</p><h1 className="mb-1 mt-1 text-2xl font-bold text-brand-900">Verified alerts</h1><p className="m-0 max-w-xl text-sm text-muted">Review recent threats confirmed by moderators and act before sharing information or money.</p></div><Link to="/analysis" className="inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-lg border border-line bg-white px-4 text-sm font-bold text-brand-800 hover:bg-brand-100"><Icon name="shield" size={17} />Analyze a similar message</Link></div>
