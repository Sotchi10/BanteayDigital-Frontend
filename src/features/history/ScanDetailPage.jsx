    ...
    return (
      <main className="min-w-0 px-5 py-5 sm:px-8" id="main-content">
        ...
        >
          ...
          <p className="mb-0 mt-4 text-sm text-muted">Loading scan details…</p>
        </Card>
      </main>
    );
  if (error)
    ...
    <main className="min-w-0 lg:px-10" id="main-content">
      <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="m-0 text-sm text-muted">
            {typeLabel(scan.inputType)} · {dateLabel(scan.createdAt)}
          </p>
        </div>
        <Link
          to="/history"
      ...
      <Card className="border-[#cbdcf0] bg-[#f8fbff] p-4 sm:p-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <h2 className="m-0 text-base font-bold text-brand-900">Assessment</h2>
        ...
        <p className="mb-0 mt-3 text-sm leading-6 text-muted">
          {scan.analysis?.summary ||
            ...
            "No additional analysis summary is available."}
        </p>
      </Card>
