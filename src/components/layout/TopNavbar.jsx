      ...
      <header className="sticky top-0 z-30 border-b border-line bg-white/95 backdrop-blur">
        <div className="mx-auto flex h-[68px] max-w-[1600px] items-center gap-4 px-4 sm:px-6 lg:px-8">
          ...
          <div className="ml-auto flex items-center gap-1.5">
            ...
            <div className="hidden min-h-11 items-center gap-2 px-1.5 lg:flex" aria-label={`Signed in as ${currentUser.name}`}><Avatar name={currentUser.name} size="sm" /><span className="hidden text-sm font-semibold xl:inline">{currentUser.name.split(" ")[0]}</span></div>
